...
int main(int argc, char* argv[]) {
  ...
  /* /\* define and set parameters *\/ */
   tmpC_TS_20161014_120734_454555_classname_set_Vsupply(Vsupply); 
  /* tmpC_TS_20161014_120734_454555_classname_set_RM(RM); */
  /* tmpC_TS_20161014_120734_454555_classname_set_inv_LM(inv_LM);  */
  /* tmpC_TS_20161014_120734_454555_classname_set_inv_JM(inv_JM);  */
  /* tmpC_TS_20161014_120734_454555_classname_set_bM(bM); */
  /* tmpC_TS_20161014_120734_454555_classname_set_Kb(Kb); */
  /* tmpC_TS_20161014_120734_454555_classname_set_KM(KM); */
  ...
  //  tmpC_TS_20161014_120734_454555_classname_set_a(a_deadzone);
  //  tmpC_TS_20161014_120734_454555_classname_set_b(b_deadzone);
  ...
  double refWeight[] = {200};
  double uWeight[] = {50};
  double nWeight[] = {1.0e8};
  double dWeight[] = {100};

  /* set weights */
  tmpC_TS_20161014_120734_454555_classname_set_refWeight(refWeight);
  tmpC_TS_20161014_120734_454555_classname_set_uWeight(uWeight);
  tmpC_TS_20161014_120734_454555_classname_set_nWeight(nWeight);
  tmpC_TS_20161014_120734_454555_classname_set_dWeight(dWeight);
  ...
  tmpC_TS_20161014_120734_454555_classname_set_upast(upast);
  tmpC_TS_20161014_120734_454555_classname_set_ypast(ypast);
  tmpC_TS_20161014_120734_454555_classname_set_uapply(uapply);
  ...
  double initU[LEN_u] = {}; 
  tmpC_TS_20161014_120734_454555_classname_set_u(initU);

  // States: current, shaft ang vel, shaft angle
  double initX0[LEN_x0] = {}; // jpp: uh, dunno: .01*randn(n,1) in mpc_dcmotor.m
  tmpC_TS_20161014_120734_454555_classname_set_x0(initX0);

  double initD[LEN_d] = {};
  tmpC_TS_20161014_120734_454555_classname_set_d(initD);

  double initX[LEN_x] = {};
  tmpC_TS_20161014_120734_454555_classname_set_x(initX);
           
  double P1lambda1_[LEN_p1l1] = {};
  tmpC_TS_20161014_120734_454555_classname_set_P1lambda1_(P1lambda1_);
            
  double P1lambda2_[LEN_p1l2] = {};
  tmpC_TS_20161014_120734_454555_classname_set_P1lambda2_(P1lambda2_);
             
  double P1nu1_[LEN_p1nu1] = {};           
  tmpC_TS_20161014_120734_454555_classname_set_P1nu1_(P1nu1_);

  double P2lambda1_[LEN_p2l1] = {};
  //double P2lambda1_[1*1] = {};
  tmpC_TS_20161014_120734_454555_classname_set_P2lambda1_(P2lambda1_);
             
  double P2lambda2_[LEN_p2l2] = {};
  tmpC_TS_20161014_120734_454555_classname_set_P2lambda2_(P2lambda2_);
            
  double P1nux1_[LEN_p1nux1] = {};
  tmpC_TS_20161014_120734_454555_classname_set_P1nux1_(P1nux1_);

  double P2nux1_[LEN_p2nux1] = {};
  tmpC_TS_20161014_120734_454555_classname_set_P2nux1_(P2nux1_);
 ...
 // Main loop
  ...
  //  tmpC_TS_20161014_120734_454555_classname_set_t(t);
  ...
  tmpC_TS_20161014_120734_454555_classname_set_ref(ref);
	...
	fprintf(flog, "%lf ", ypast[i]);
      ...
      tmpC_TS_20161014_120734_454555_classname_set_upast(upast);    // Where is upast defined? Grabbed from the db? Yupperoo
    ...
    tmpC_TS_20161014_120734_454555_classname_getOutputs(optJ,
							optU,
							optD,
							optX,
							optX0,
