// time how many cycles it takes to read an ADC.
...
// We'll set up these variable names instead of using the raw register names: 
    ...
    #define start_time     r11
    #define stop_time         r12
    #define encoders    r13
...
// Sample:
	...
	// Save the value of the cycle counter:
	LBCO start_time, C28, 0xC, 4     // Load "before" cycle count
...
// Write to data ram the start and stop times:
	SBBO start_time, reg_PRU_DATA_RAM_BASE, 4, 4  // "start" time
	
	SBBO stop_time, reg_PRU_DATA_RAM_BASE, 8, 4  // "end" time
